...
_BASE_PROMPT = (
    ...
    "scroll(direction), press_home(). These work via the SimulateTouch "
    "package's `stouch` binary. If a tap call returns 'stouch not installed', "
    "call apt_install('SimulateTouch', ...) and retry.\n"
