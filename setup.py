...
def main() -> int:
    ...
    # ── 1. Telegram token ────────────────────────────────────────────────
    step(1, 5, "Telegram bot token (from @BotFather)")
    while True:
    ...
    # ── 3. Allowed user ID ───────────────────────────────────────────────
    step(3, 5, "Your Telegram numeric user ID (from @userinfobot)")
    ...
    # ── 5. Heartbeat ─────────────────────────────────────────────────────
    step(5, 5, "Heartbeat — periodic self-prompts (Phase 2.2 — not yet implemented)")
    ...
    print()
    print(f"  Start the bot:  {DIM}iagent{RESET}    (requires tmux: apt install tmux)")
    print(f"  Local CLI:      {DIM}iagent chat{RESET}")
    print(f"  Tail logs:      {DIM}iagent logs{RESET}")
    print()
    print("  Then in Telegram, search for your bot and tap Start.")
    return 0
